...
echo "Starting HPS_Heartland install on \${Magento2Version}" >> HPS_Heartland.log

if [ \${Magento2} ] ; then
    echo "Found \$Magento2";
    echo "Found \$Magento2" >> HPS_Heartland.log;

    Magento2Base=\${Magento2%%\/bin\/magento}

    echo "Magento Base Directory Found: \$Magento2Base"
    echo "Magento Base Directory Found: \$Magento2Base" >> HPS_Heartland.log

    echo "Downloading HPS_Heartland from github"
    echo "Downloading HPS_Heartland from github" >> HPS_Heartland.log
    git clone -b Magento-2-1-1-updates https://github.com/hps/heartland-magento2-module.git  2>> HPS_Heartland.log

    echo "Creating the Dir \${Magento2Base}/app/code "
    echo "Creating the Dir \${Magento2Base}/app/code " >> HPS_Heartland.log
    rm -rf \${Magento2Base}/app/code/HPS 2>> HPS_Heartland.log
    rm -rf \${Magento2Base}/vendor/HPS 2>> HPS_Heartland.log
    #mkdir \$Magento2Base/app/code 2>> HPS_Heartland.log
    ...
    rm -rf heartland-magento2-module 2>> HPS_Heartland.log

    echo "Getting dependencies for  HPS_Heartland" >> HPS_Heartland.log
    cd \${Magento2Base}
    composer require hps/heartland-php  2>> HPS_Heartland.log

    echo "Clearing all cache"
    echo "Clearing all cache" >> HPS_Heartland.log
    rm -rf \${Magento2Base}/var/cache/* 2>> HPS_Heartland.log
    rm -rf \${Magento2Base}/var/page_cache/* 2>> HPS_Heartland.log
    rm -rf \${Magento2Base}/var/generation/* 2>> HPS_Heartland.log
    rm -rf \${Magento2Base}/var/di 2>> HPS_Heartland.log
    rm -rf \${Magento2Base}/pub/static/adminhtml 2>> HPS_Heartland.log
    rm -rf \${Magento2Base}/pub/static/frontend 2>> HPS_Heartland.log
    rm -rf \${Magento2Base}/var/report/* 2>> HPS_Heartland.log

    echo "Execute cache:clean"
    echo "Execute cache:clean" >> HPS_Heartland.log
    php \${Magento2} cache:clean 2>> HPS_Heartland.log

    echo "Execute module:enable HPS_Heartland"
    echo "Execute module:enable HPS_Heartland" >> HPS_Heartland.log
    php \${Magento2} module:enable HPS_Heartland 2>> HPS_Heartland.log

    echo "Executing setup:upgrade --keep-generated"
    echo "Executing setup:upgrade --keep-generated" >> HPS_Heartland.log
    php \${Magento2} setup:upgrade --keep-generated 2>> HPS_Heartland.log

    echo "Executing setup:di:compile"
    echo "Executing setup:di:compile" >> HPS_Heartland.log
    php \${Magento2} setup:di:compile 2>> HPS_Heartland.log

    echo "Executing setup:static-content:deploy"
    echo "Executing setup:static-content:deploy" >> HPS_Heartland.log
    php \${Magento2} setup:static-content:deploy 2>> HPS_Heartland.log

    echo "Done Installing HPS_Heartland"
    echo "Done Installing HPS_Heartland" >> HPS_Heartland.log
else
    echo "Sorry we could not automate the process of installing our HPS_Heartland plug-in"
    echo "Sorry we could not automate the process of installing our HPS_Heartland plug-in" >> HPS_Heartland.log

    echo "Please submit an issue https://github.com/hps/heartland-magento2-module/issues"
    echo "Please submit an issue https://github.com/hps/heartland-magento2-module/issues" >> HPS_Heartland.log
exit
fi
